<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminLogin.aspx.cs" Inherits="ItHelper.adminLogin" %>
                            ...
                            <div class="row">
                                <div class="col">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <asp:Button class="btn btn-info btn-block btn-lg" ID="Button2" runat="server" Text="SignUp" />
                                    </div>
                                  </div> 
                            </div>
                        </div>
