<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="userLogin.aspx.cs" Inherits="ItHelper.userLogin" %>
                            ...
                            <div class="row">
                                <div class="col">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <asp:Button class="btn btn-info btn-block btn-lg" ID="Button2" runat="server" Text="Zarejestruj się" OnClick="Button2_Click" />
                                    </div>
                            </div>
                        </div>
